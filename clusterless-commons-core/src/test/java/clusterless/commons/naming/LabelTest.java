...
public class LabelTest {
    ...
    void string() {
        ...
        Assertions.assertEquals("Lower", Label.fromLowerHyphen("lower").camelCasePath());
        ...
        Assertions.assertEquals("Lower/Case", with.camelCasePath());
        ...
        Assertions.assertEquals("LowerCase/Word", withCamel.camelCasePath());
        ...
        Assertions.assertEquals("Lower/Case/Word", withLongCamel.camelCasePath());
        ...
        Assertions.assertEquals("Lower/Case", withNull.camelCasePath());
        ...
        Assertions.assertEquals("Lower/Case", withMidNull.camelCasePath());
    ...
    @Test
    void enumeration() {
        Assertions.assertEquals("Lower", Label.of(Value.Lower).camelCase());
        Assertions.assertEquals("Lwr", Label.of(Value.Lower).shortCamelCase());

        Assertions.assertEquals("LowerCase", Label.of(Value.Lower).with(Value.Case).camelCase());
        Assertions.assertEquals("lwr-cs", Label.of(Value.Lower).with(Value.Case).shortLowerHyphen());
    }

    @Test
    void enumerationWithNull() {
        Assertions.assertEquals("LowerCase", Label.of(null).with(Value.Lower).with(Value.Case).camelCase());
        Assertions.assertEquals("lwr-cs", Label.of(null).with(Value.Lower).with(Value.Case).shortLowerHyphen());

        Assertions.assertEquals("LowerCase", Label.of(Value.Lower).with(null).with(Value.Case).camelCase());
        Assertions.assertEquals("lwr-cs", Label.of(Value.Lower).with(null).with(Value.Case).shortLowerHyphen());
    }
}
